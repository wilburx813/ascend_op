...
[[maybe_unused]] uint32_t NNOPBASE_IsClose = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnIsCloseTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "IsClose";
    char inputDesc[] = {1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {0, 0, 0};
