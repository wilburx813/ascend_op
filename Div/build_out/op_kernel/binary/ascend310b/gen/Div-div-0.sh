...
res=$(opc $1 --main_func=div --input_param=/root/ascend_op/op/Div/build_out/op_kernel/binary/ascend310b/gen/Div_bd2afc5d7db60438974dd57f515f0afb_param.json --soc_version=Ascend310B1                 --output=$2 --impl_mode=high_performance,optional --simplified_key_mode=0 --op_mode=dynamic )
