...
[[maybe_unused]] uint32_t NNOPBASE_Softmax = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnSoftmaxTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "Softmax";
    char inputDesc[] = {1};
    char outputDesc[] = {1};
    char attrDesc[] = {0};
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddAttrWithDtype(*executor, static_cast<void*>(&dimOptional), sizeof(int64_t), 0, kNnopbaseInt));
