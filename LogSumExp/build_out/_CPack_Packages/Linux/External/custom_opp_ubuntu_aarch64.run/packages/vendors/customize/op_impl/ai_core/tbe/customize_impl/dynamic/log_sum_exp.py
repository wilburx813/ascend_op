...
def log_sum_exp(x_in__, y_out_, dim=[0], keep_dim=False, kernel_name="log_sum_exp", impl_mode=""):
    ...
    print("start compile Ascend C operator LogSumExp. kernel name is " + kernel_name)
    op_type = "LogSumExp"
...
def op_select_format(x_in__, y_out_, dim=[0], keep_dim=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, y_out_, dim, keep_dim)
    result = check_op_cap("op_select_format", "LogSumExp", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, y_out_, dim=[0], keep_dim=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, y_out_, dim, keep_dim)
