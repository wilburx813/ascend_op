...
scripts/install.sh:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/ascend_op/op/LogSumExp/build_out/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating scripts/install.sh, scripts/upgrade.sh"
	mkdir -p /root/ascend_op/op/LogSumExp/build_out/scripts
	cp -r /root/ascend_op/op/LogSumExp/scripts/* /root/ascend_op/op/LogSumExp/build_out/scripts/
	sed -i s/vendor_name=customize/vendor_name=customize/g /root/ascend_op/op/LogSumExp/build_out/scripts/*
...
CMakeFiles/modify_vendor.dir/depend:
	cd /root/ascend_op/op/LogSumExp/build_out && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/ascend_op/op/LogSumExp /root/ascend_op/op/LogSumExp /root/ascend_op/op/LogSumExp/build_out /root/ascend_op/op/LogSumExp/build_out /root/ascend_op/op/LogSumExp/build_out/CMakeFiles/modify_vendor.dir/DependInfo.cmake --color=$(COLOR)
