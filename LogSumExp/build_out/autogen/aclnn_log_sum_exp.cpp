    ...
    aclOpExecutor **executor)
{
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    if (dimOptional) {
        ...
        static int64_t dimOptionalDef[] = {0};
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddAttrWithDtype(*executor, static_cast<void*>(&keepDimOptional), sizeof(bool), 1, kNnopbaseBool));
